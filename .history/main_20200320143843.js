...
class Player {
    ...
    keyboardTick() {
        ...
        if (this._pressedKeys["w"] && this.cursorPosition.y >= this._Game.World.canvasBoundary.minY + this._Gams.World.targetDimension.center.y)
...
class World {
    ...
    constructor() {
        ...
        this.targetDimension = {
            ...
            center: {
                x: Math.floor(this._targetRect.width / 2) - 10,
                y: Math.floor(this._targetRect.width / 2)
            }
        }
        this.onWindowResize();
