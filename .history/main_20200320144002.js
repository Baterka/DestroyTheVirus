...
class Player {
    ...
    keyboardTick() {
        ...
        if (this._pressedKeys["w"] && this.cursorPosition.y >= this._Game.World.canvasBoundary.minY + this._Games.World.targetDimension.center.y)
        ...
        if (this._Game.debug) {
            this._debugDotElem.style.top = (this.cursorPosition.y - 1) + "px";
