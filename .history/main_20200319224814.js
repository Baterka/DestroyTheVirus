...
class AudioController {
    ...
    constructor() {
        ...
        for (let key in audioTracks) {
            this._audioElems[key] = document.createElement("audio");
    ...
    play(name) {
        console.log(this._audioElems[name]);
        if (this._audioElems[name]) {
            this._audioElems[name].muted = true;
            this._audioElems[name].currentTime = 0;
            this._audioElems[name].play();
            this._audioElems[name].muted = false;
        } else
