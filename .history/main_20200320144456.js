...
class Virus {
    ...
    _spawner() {
        ...
        this._spawnerTimer = setTimeout(() => {
            const x = randomNumber(this._Game.World.canvasBoundary.minX, this._Game.World.canvasBoundary.maxX);
            const y = randomNumber(this._Game.World.canvasBoundary.minY, this._Game.World.canvasBoundary.maxY);
            this.spawn(x, y);
            this._spawner();
        }, this._spawnRate);
    }
