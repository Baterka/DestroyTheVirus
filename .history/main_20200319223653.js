...
class AudioController {
    ...
    _audioElem = document.createElement("audio");

    constructor() {
        console.log(this._audioElem);


        document.getElementsByTagName("body")[0].appendChild(this._audioElem);
        ...
        for (let key in audioTracks) {
            ...
            audioSourceElem.src = audioTracks[key];
            this._audioElem.appendChild(audioSourceElem);
        }
        console.log(this._audioElem.audioTracks);
    }
    ...
    play(name) {
        if (this._audioTracks[name]) {
            ...
            console.error(`Audio track '${name}' does not exist.`);
    }
}
