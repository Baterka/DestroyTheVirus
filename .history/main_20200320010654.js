...
class World {
    ...
    constructor() {
        ...
        this._canvasBoundary = {
            ...
            maxX: this._canvasRect.width,
            maxY: this._canvasRect.height
        }
    }
    ...
    moveTarget(x, y) {
        ...
        this._target.style.left = (x - this.targetDimension.width / 2) + "px";
        this._target.style.top = (y - this.targetDimension.height / 2) + "px";
    }
