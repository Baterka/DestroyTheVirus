...
class AudioController {
    ...
    _audioElem = document.getElementById("audioSource");

    play(name) {
        if (this._audioList[name]) {
            this._audioElem.src = this._audioList[name];
...
class Game {
    ...
    constructor() {
        ...
        setTimeout(() => this._Audio.play("fail"), 1000);
    }
    ...
    init() {
        ...
        this._Player = new Player(document.querySelector('input[name="input"]:checked'));
