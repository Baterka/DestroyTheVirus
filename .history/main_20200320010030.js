...
class World {
    ...
    moveTarget(x, y) {
        ...
        // Allow "corner sliding"
        x = (x > 0 ? (x < this.mapBoundary.maxX ? x : this.mapBoundary.maxX) : this.mapBoundary.minX)
        y = (y > 0 ? (y < this.mapBoundary.maxY ? y : this.mapBoundary.maxY) : this.mapBoundary.minY)
